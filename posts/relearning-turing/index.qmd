...
online book on [Applied Modelling in Drug Development](https://opensource.nibr.com/bamdd/src/02g_longitudinal.html#data) written by statisticians from Novartis.
...
and `BASE` is the baseline PASI score, and AVAL is the outcome score at week 12.
The specific prior does not concern us.
